...
describe('WorkoutRepository: findById', () => {
  ...
  it('should successfully return a workout', async () => {
    const workout = await workoutRepo.findById(
    ...
    expect(workout?.exercises[0].sets[0].order).toBe(1);
    expect(workout?.exercises[0].sets[1].order).toBe(2);
    expect(workout?.exercises[0].sets[2].order).toBe(3);
    expect(workout?.exercises[1].order).toBe(2);
    expect(workout?.exercises[1].sets[0].order).toBe(1);
    expect(workout?.exercises[1].sets[1].order).toBe(2);
    expect(workout?.exercises[1].sets[2].order).toBe(3);
  });
});
